--Tapetries by Zapatron and leandro_benedetti_--
 ...
 elseif item.itemid == 1856 or item.itemid == 1859 or item.itemid == 1862 or item.itemid == 1865 or item.itemid == 1868 or item.itemid == 1871 or item.itemid == 1879 then
 doRemoveItem(item.uid,1)
 doCreateItem(item.itemid-1,1,cortina2)
 return 1
 
 elseif item.itemid == 1855 or item.itemid == 1858 or item.itemid == 1861 or item.itemid == 1864 or item.itemid == 1867 or item.itemid == 1870 or item.itemid == 1878 then
 doRemoveItem(item.uid,1)
