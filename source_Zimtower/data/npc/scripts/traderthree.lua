...
conv = 0
 ...
 function onCreatureSay(cid, type, msg)
 	...
 	if msgcontains(msg, 'quest') and focus == cid and getPlayerStorageValue(cid,20029) == -1 then
 		selfSay('Bring me something like I want. I like want blue robe yes you this good is for me. itens?')
		conv = 1
 		talk_start = os.clock()
	end
 
	if msgcontains(msg, 'robe') and getPlayerStorageValue(cid,20029) == -1 and focus == cid then
		conv = 1
	...
	if msgcontains(msg, 'yes') and conv == 1 and focus == cid then
 		talk_start = os.clock()
		if doPlayerRemoveItem(cid,2656) == 0 then
		buy(cid,2258,1,0)
		setPlayerStorageValue(cid,20029,1)
		conv = 0
		selfSay('Hahahaha I trick you I am bes mage world hahaha kekekeke hehehehe oooo you rat hahaha')
		else
