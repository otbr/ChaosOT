...
function onCreatureSay(cid, type, msg)
  	...
  	if (msgcontains(msg, 'hi') and (focus == 0)) and getDistanceToCreature(cid) < 4 then
  		selfSay('Hello, ' .. creatureGetName(cid) .. '! I sell ropes (50gp), shovels (20gp), backpacks (10gp), and picks (1m) for mining lumberjack (1m).. also lumberjack axes you may use them on plum trees for a special hunting area.')
  		focus = cid
  		talk_start = os.clock()
